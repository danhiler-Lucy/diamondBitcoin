...
$(function() {
    setInterval(function(){ 
        var onlineUsers=254;
        onlineUsers=onlineUsers+Math.floor((Math.random() * 20) + 1);

        var onlineProductsInView=182;
        onlineProductsInView=onlineProductsInView+Math.floor((Math.random() * 20) + 1);
        $('#onlineUsersCount').html(onlineUsers);
        $('#onlineProductsCount').html(onlineProductsInView);
     }, 2000);
});
